"""Knowledge upload API contracts — platform → admin dashboard."""
...
class KnowledgeUploadersResponse(BaseModel):
    """Distinct hierarchy users who uploaded active knowledge documents."""

    uploaders: list[SourceDocumentActorRef] = Field(default_factory=list)

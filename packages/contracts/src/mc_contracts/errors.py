...
class ErrorCode(str, Enum):
    ...
    MERGE_SPLIT_NOT_PRIMARY = "merge_split_not_primary"
    MERGE_SPLIT_NOT_REVIEW_PENDING = "merge_split_not_review_pending"
    MERGE_SPLIT_SECONDARY_UNAVAILABLE = "merge_split_secondary_unavailable"
    ...
    BADGE_NAME_CONFLICT = "badge_name_conflict"
    ...
    HIERARCHY_USER_NOT_FOUND = "hierarchy_user_not_found"
    HIERARCHY_USER_CONFLICT = "hierarchy_user_conflict"
    HIERARCHY_PARENT_INVALID = "hierarchy_parent_invalid"
    HIERARCHY_ROLE_MISMATCH = "hierarchy_role_mismatch"
    HIERARCHY_AUTH_FAILED = "hierarchy_auth_failed"
    HIERARCHY_IMPORT_INVALID = "hierarchy_import_invalid"

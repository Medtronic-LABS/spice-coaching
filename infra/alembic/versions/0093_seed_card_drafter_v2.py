"""Seed card-drafter prompt v2 (draft-time image selection).

Adds card-drafter v2 with source_image_ids output field and image catalog
variables; deactivates v1.

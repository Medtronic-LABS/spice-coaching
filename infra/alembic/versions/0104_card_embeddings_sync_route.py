"""Seed /sync/card-embeddings into api_route and role_route_access.
...
from platform_service.db.models.hierarchy_user import ROLE_PO, ROLE_SHASTIYA_KORMI
...
def upgrade() -> None:
    ...
    for role_code in (ROLE_PO, ROLE_SHASTIYA_KORMI):

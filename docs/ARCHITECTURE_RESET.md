...
2. Per-module LLM call: for each candidate, draft Bangla cards (canonical) + English mirror, plus card source provenance. Output writes directly to `module` rows.

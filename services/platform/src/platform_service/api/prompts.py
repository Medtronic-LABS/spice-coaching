...
from mc_contracts.prompts import (
...
async def list_prompt_catalog(
    ...
    rows = await repo.list_catalog(tenant_id=get_selected_tenant_id(request))
...
async def create_prompt_version(
    ...
    active = await repo.get_active(template_id, variant_key=body.variant_key, tenant_id=tenant_id)

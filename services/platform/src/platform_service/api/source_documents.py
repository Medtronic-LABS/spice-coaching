...
def _list_item_from_document(
    ...
    *,
    ...
    return SourceDocumentListItem(
        ...
        ingested_at=doc.ingested_at,
        updated_at=doc.updated_at,
        uploaded_by=to_user_actor_ref(doc.uploaded_by, users_by_id),
        updated_by=to_user_actor_ref(doc.updated_by, users_by_id),
        ingested_by=to_user_actor_ref(doc.ingested_by, users_by_id),

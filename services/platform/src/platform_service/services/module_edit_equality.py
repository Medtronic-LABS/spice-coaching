...
# under module_json. chatbot_faqs_only is omitted from snapshot completeness and
# content equality so an omitted or identical flag still no-ops; the API skips
# the no-op when the flag is explicitly set to a different value.

...
class HierarchyService:
    ...
    async def create_division(
        ...
        *,
        ...
        return await self._division_response_resolved(division)
    ...
    async def list_divisions(
        ...
        *,
        ...
        for d in divisions:
            actor_ids.extend([d.created_by, d.updated_by])
        users_by_id = await self._actors_by_ids(*actor_ids)
        return DivisionListResponse(
            divisions=[self._division_response(d, users_by_id=users_by_id) for d in divisions],
            total=total,
    ...
    async def list_districts(
        ...
        *,
        ...
        return DistrictListResponse(
            districts=[
                self._district_response_with_names(d, division_names=division_names, users_by_id=users_by_id)
                for d in districts
            ],
            total=total,
            total_pages=total_pages,
    ...
    async def create_upazila(
        ...
        *,
        ...
        return await self._upazila_response_resolved(upazila)
    ...
    async def list_upazilas(
        ...
        *,
        ...
        actor_ids: list[int | None] = []
        for u in upazilas:
            actor_ids.extend([u.created_by, u.updated_by])
        users_by_id = await self._actors_by_ids(*actor_ids)
        return UpazilaListResponse(
            upazilas=[self._upazila_response(u, users_by_id=users_by_id) for u in upazilas],
            total=total,
            total_pages=total_pages,
            limit=limit,
            offset=offset,
    ...
    async def _district_response(self, district: District, *, tenant_id: int) -> DistrictResponse:
        ...
        users_by_id = await self._actors_by_ids(district.created_by, district.updated_by)
    ...
    async def _actors_by_ids(self, *user_ids: int | None) -> dict[int, HierarchyUser]:
        ids = [uid for uid in user_ids if uid is not None]
        if not ids:
            return {}
        return await self._repo.get_users_by_ids(ids)

    async def _division_response_resolved(self, division: Division) -> DivisionResponse:
        users_by_id = await self._actors_by_ids(division.created_by, division.updated_by)
        return self._division_response(division, users_by_id=users_by_id)

    async def _upazila_response_resolved(self, upazila: Upazila) -> UpazilaResponse:
        users_by_id = await self._actors_by_ids(upazila.created_by, upazila.updated_by)
        return self._upazila_response(upazila, users_by_id=users_by_id)

    @staticmethod
    def _division_response(
        division: Division,
        *,
        ...
        return DivisionResponse(
            ...
            created_by=to_user_actor_ref(division.created_by, users_by_id),
            updated_by=to_user_actor_ref(division.updated_by, users_by_id),
        )
    ...
    def _district_response_with_names(
        ...
        *,
        ...
        return DistrictResponse(
            ...
            created_by=to_user_actor_ref(district.created_by, users_by_id),
            updated_by=to_user_actor_ref(district.updated_by, users_by_id),
        )

    @staticmethod
    def _upazila_response(
        upazila: Upazila,
        *,
        users_by_id: dict[int, HierarchyUser] | None = None,
    ) -> UpazilaResponse:
        return UpazilaResponse(
            ...
            created_by=to_user_actor_ref(upazila.created_by, users_by_id),
            updated_by=to_user_actor_ref(upazila.updated_by, users_by_id),
        )
    ...
    async def _user_responses(
        ...
        *,
        ...
        actor_ids: list[int | None] = []
        for user in users:
            actor_ids.extend([user.created_by, user.updated_by])
            for upazila in user.upazilas:
                actor_ids.extend([upazila.created_by, upazila.updated_by])
        users_by_id = await self._actors_by_ids(*actor_ids)
        return [
    ...
    async def _user_response(self, user: HierarchyUser, *, tenant_id: int) -> HierarchyUserResponse:
        ...
        actor_ids: list[int | None] = [user.created_by, user.updated_by]
        for upazila in user.upazilas:
            actor_ids.extend([upazila.created_by, upazila.updated_by])
        users_by_id = await self._actors_by_ids(*actor_ids)
    ...
    def _user_response_with_context(
        ...
        *,
        ...
        return HierarchyUserResponse(
            ...
            division_id=division_id,
            division=division_name,
            upazilas=[cls._upazila_response(u, users_by_id=users_by_id) for u in user.upazilas],
            tenant_id=user.tenant_id,
            created_at=user.created_at,
            updated_at=user.updated_at,
            created_by=to_user_actor_ref(user.created_by, users_by_id),
            updated_by=to_user_actor_ref(user.updated_by, users_by_id),
        )

...
from mc_foundation.logging import get_audit_logger, get_security_logger
    ...
    async def dispatch(self, request: Request, call_next) -> Response:  # type: ignore[no-untyped-def]
        ...
        try:
            async with SessionLocal() as session:
                hierarchy_role_id = await enforce_hierarchy_principal(session, user_detail)
        ...
        request.state.hierarchy_role_id = hierarchy_role_id

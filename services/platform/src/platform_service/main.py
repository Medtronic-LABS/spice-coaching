...
def create_app() -> FastAPI:
    ...
    # Last added runs first on the request. Auth/authorization/rate-limit first on
    # non-OPTIONS calls; CORS must be outermost so preflight never hits auth and
    # always gets Access-Control-Allow-Origin (required for custom headers like auth-cookie).

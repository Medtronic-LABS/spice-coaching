...
class Module(Base):
    ...
    # Denormalised: the primary behavioural_gap this module addresses, when a
    # reviewer has authored a binding for it. Pipeline never writes this —
    # only the admin dashboard does.

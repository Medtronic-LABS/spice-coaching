...
class ModuleAssignment(TenantMixin, Base):
    """Per-user module assignment: one row per (module, assignee)."""

    __tablename__ = "module_assignment"
    __table_args__ = (UniqueConstraint("module_id", "user_id", name="uq_module_assignment_user"),)
